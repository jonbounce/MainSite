          ...
          <Form.Row>
            <Form.Group
              ...
              <Form.Label
                ...
                style={{fontSize:20}}
              >How many members are in household?</Form.Label>
            ...
            <>
              ...
              {[...Array(Number(householdNo)).keys()].map((value, i) =>
                <>
                  ...
                  <Form.Row>
                   <Form.Group as={Col} controlId="Church-address">
                      <Form.Label>Church address</Form.Label>
                      <Form.Control type="text" placeholder="Email address"
                        value={householdMembers[i].church} onChange={(e) => updateMemberDetails(i, 'church', e.target.value)}
                      />
                    </Form.Group>
                  ...
                  <Form.Row>
                   <Form.Group as={Col} controlId="date">
                      ...
                      <Form.Control type="date"
                        value={householdMembers[i].date} onChange={(e) => updateMemberDetails(i, 'date', e.target.value)}
                     />
                        
    
                    </Form.Group>
                    {
                        (householdMembers[i].category!="Grand Father"&&householdMembers[i].category!="Grand Mother"&&householdMembers[i].category!="")&&(
                            <>
